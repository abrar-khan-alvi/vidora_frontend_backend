...
const SHOWCASE = {
  ...
  gallery: [
    { src: '/showcase/g-1.jpg', poster: '', kind: 'image' as const, tag: 'Image · Style' },
    { src: '/showcase/g-2.mp4', poster: '/showcase/g-2.jpg', kind: 'video' as const, tag: 'Video · Cinematic' },
    { src: '/showcase/g-3.jpg', poster: '', kind: 'image' as const, tag: 'Image · Reference' },
    { src: '/showcase/g-4.jpg', poster: '', kind: 'image' as const, tag: 'Image · Style' },
    { src: '/showcase/g-5.mp4', poster: '/showcase/g-5.jpg', kind: 'video' as const, tag: 'Video · Cinematic' },
