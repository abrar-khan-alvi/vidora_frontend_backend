                    ...
                    return (
                      <div
                        ...
                        className={`group flex items-center rounded-xl transition-all ${
                          active ? 'bg-[#9758FF]/15 border border-[#9758FF]/20' : 'hover:bg-white/[0.03] border border-transparent'
                        }`}
                      >
                        <button
                          onClick={() => {
                          ...
                          className={`flex-1 text-left px-3.5 py-3 text-[13px] truncate ${
                            active ? 'text-white font-bold' : 'text-[#A1A1A5] hover:text-white'
                          }`}
                        >
