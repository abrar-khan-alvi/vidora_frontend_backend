                ...
                {filteredClones.map((v) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative flex items-center gap-3 px-3.5 py-3 rounded-xl border transition-all cursor-pointer group ${isSel
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={!hasPreview}
                        className={`h-9 w-9 rounded-lg flex items-center justify-center shrink-0 transition-all ${isPlaying
                ...
                {filteredStock.map((v) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative flex items-center gap-3 px-3.5 py-3 rounded-xl border transition-all cursor-pointer ${isSel
                          ? 'border-[#9758FF] ring-2 ring-[#9758FF]/25 bg-[#9758FF]/10'
                          : 'border-white/[0.07] hover:border-white/[0.18] hover:bg-white/[0.02]'
                        }`}
                    >
